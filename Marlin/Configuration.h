...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sidewinder X1
  #define DEFAULT_Kp 11.92//22.2
  #define DEFAULT_Ki 0.87//1.08
  #define DEFAULT_Kd 40.97//114
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 448.11 } //{ 80.121, 80.121, 399.778, 445 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 101   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN     49       // LED driving pin
