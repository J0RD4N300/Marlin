...
#define STRING_CONFIG_H_AUTHOR "Jordan" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sidewinder X1
  #define DEFAULT_Kp 11.92//12.19
  #define DEFAULT_Ki 0.87//0.89
  #define DEFAULT_Kd 40.97//41.93
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Sidewinder X1
  #define DEFAULT_bedKp 57.71  //244.21
  #define DEFAULT_bedKi 8.81   //45.87
  #define DEFAULT_bedKd 252.09 //325.08
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 448.11 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 101   // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    49        // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
